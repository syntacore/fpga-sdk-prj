...
#
# arty_scr1_.tcl: Tcl script for re-creating project 'arty_scr1'
#
# Generated by Vivado on Thu Aug 10 14:16:46 +0300 2017
...
set files [list \
 ...
 "[file normalize "$origin_dir/../../../scr1/src/core/primitives/scr1_cg.sv"]"\
 "[file normalize "$origin_dir/../../../scr1/src/core/scr1_sync_rstn.sv"]"\
 "[file normalize "$origin_dir/../../../scr1/src/core/scr1_clk_ctrl.sv"]"\
...
set file "$origin_dir/../../../scr1/src/core/primitives/scr1_cg.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "SystemVerilog" $file_obj
set_property "is_enabled" "1" $file_obj
...
set file "$origin_dir/../../../scr1/src/core/scr1_clk_ctrl.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "SystemVerilog" $file_obj
set_property "is_enabled" "1" $file_obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7a35ticsg324-1L -flow {Vivado Synthesis 2016} -strategy "Flow_PerfOptimized_high" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7a35ticsg324-1L -flow {Vivado Implementation 2016} -strategy "Performance_WLBlockPlacement" -constrset constrs_2 -parent_run synth_1
} else {
