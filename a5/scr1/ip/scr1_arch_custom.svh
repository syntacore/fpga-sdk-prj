...
`define SCR1_TARGET_FPGA_INTEL      ALTERA
...
`ifdef SCR1_TCM_EN
parameter bit [`SCR1_DMEM_AWIDTH-1:0]   SCR1_TCM_ADDR_MASK          = 'hFFFE0000;   // 128KB
parameter bit [`SCR1_DMEM_AWIDTH-1:0]   SCR1_TCM_ADDR_PATTERN       = 'hF0000000;   // Base address
`endif // SCR1_TCM_EN
